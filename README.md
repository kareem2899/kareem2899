...
```python
class KarimHasabelnaby:
    def __init__(self):
        self.name        = "Karim Hasabelnaby"
        self.age         = 24
        ...
        self.tools       = ["PyTorch", "TensorFlow", "OpenCV", "YOLOv8", "U-Net", "Django"]
        self.contact     = "kareem.mamdouhk42@gmail.com"

    def mission(self):
        return "Building intelligent systems that reshape how we see and understand the world 🛰️"
...
![Sentinel](https://img.shields.io/badge/Copernicus_Sentinel-003247?style=for-the-badge&logo=esa&logoColor=white)
...
> 🥇 **1st Place individually** in Problem-Solving Track — AI Olympiad, Alamein University
>
> 🥈 **2nd Place overall** with team — AI Olympiad, Alamein University
>
> 🏅 **4th Place out of 64 university teams** — "Imagine the Future" by Shell Company
>
> 🎓 **GPA 3.686 · Ranked 2nd in entire AI Science Major** — Galala University
